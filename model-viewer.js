...
AFRAME.registerComponent('model-viewer', {
  ...
  initUploadInput: function () {
    ...
    var css =
      ...
      '.a-upload-model-button {cursor: pointer; padding: 0px 2px 0 2px; font-weight: bold; color: #666; border: 3px solid #666; box-sizing: border-box; vertical-align: middle; width: 25%; max-width: 110px; border-radius: 10px; height: 34px; background-co
